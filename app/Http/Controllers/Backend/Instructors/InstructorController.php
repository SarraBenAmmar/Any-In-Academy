...
class InstructorController extends Controller
{
     ...
     */
    public function create(AddNewRequest $request){
     try {
            DB::beginTransaction();
            $instructor = new Instructor;
            $instructor->name = $request->fullName_en;
            $instructor->contact = $request->contactNumber_en;
...
if ($instructor->save()) {
    ...
    $user->name = $request->fullName_en;
    $user->email = $request->emailAddress;
    $user->contact = $request->contactNumber_en;
    $user->role_id = 3;
    ...
    public function frontShow($id)
    {
        ...
        // dd($course);
        return view('instructor.instructorProfile', compact('instructor'));
    }
