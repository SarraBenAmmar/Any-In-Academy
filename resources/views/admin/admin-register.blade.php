            ...
            <div class="row align-items-center justify-content-md-center">
                <div class="col-lg-5 order-2 order-lg-0">
                    <div class="signup-area-textwrapper">
                        <h2 class="font-title--md mb-0">Admin Sign Up</h2>
                        <p class="mt-2 mb-lg-4 mb-3">Already have an account? <a href="{{ route('admin.login.form') }}" class="text-black-50">Sign In</a></p>
                        ...
                        <form action="{{ route('admin.register.store', 'dashboard') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-element">
                                <label for="email">Email for Admin</label>
                            ...
                            <div class="form-element">
                                ...
                                <input type="text" placeholder="Enter Your Phone Number" id="phone" name="phone" value="{{ old('phone') }}" />
                                @if ($errors->has('phone'))
