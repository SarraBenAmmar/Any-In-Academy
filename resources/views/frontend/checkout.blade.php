                            ...
                            <div class="cart">
                                ...
                                <div class="cart__checkout-process">
                                    <ul>
                                        <li>
                                            <p>Subtotal</p>
                                            <p>{{ '৳' . (session('cart_details')['cart_total'] ?? '0.00') }}</p>
                                        </li>
                                        <li>
                                            <p>Coupon Discount ({{ session('cart_details')['discount'] ?? 0.00 }}%)</p>
                                            <p>{{ '৳' . (session('cart_details')['discount_amount'] ?? '0.00') }}</p>
                                        </li>
                                        <li>
                                            <p>Taxes (15%)</p>
                                            <p>{{ '৳' . (session('cart_details')['tax'] ?? '0.00') }}</p>
                                        </li>
                                        <li>
                                            <p class="font-title--card">Total:</p>
                                            <p class="total-price font-title--card">{{ '৳' . (session('cart_details')['total_amount'] ?? '0.00') }}</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
