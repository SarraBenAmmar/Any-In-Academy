            ...
            <div class="row align-items-center">
                <div class="col-xl-5 order-2 order-xl-0">
                    <div class="signup-area-textwrapper">
                        <h2 class="font-title--md mb-0">Sign in Student</h2>
                        <p class="mt-2 mb-lg-4 mb-3">Don't have an account? <a href="{{route('studentRegister')}}" class="text-black-50">Sign up</a></p>
                        ...
                        <form action="{{route('studentLogin.check', 'studentdashboard')}}" method="POST">
                            ...
                            <div class="form-element">
                                ...
                                <input type="email" placeholder="Username" id="email" name="email" value="{{ old('email') }}" />
                                @error('email')
