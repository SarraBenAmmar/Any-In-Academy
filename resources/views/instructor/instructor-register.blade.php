            ...
            <div class="row align-items-center justify-content-md-center">
                <div class="col-lg-5 order-2 order-lg-0">
                    <div class="signup-area-textwrapper">
                        ...
                        <p class="mt-2 mb-lg-4 mb-3">Already have an account? <a href="{{ route('instructorLogin.form') }}" class="text-black-50">Sign In</a></p>
                        ...
                        <form action="{{ route('instructorRegister.store', 'instructorDashboard') }}" method="POST">
                            ...
                            <div class="form-element">
                                <label for="email">Email for Instructor</label>
