            ...
            <div class="row align-items-center justify-content-md-center">
                <div class="col-lg-5 order-2 order-lg-0">
                    <div class="login-area-textwrapper">
                        <h2 class="font-title--md mb-0">Instructor Login</h2>
                        <p class="mt-2 mb-lg-4 mb-3">Don't have an account? <a href="{{ route('instructorRegister.form') }}" class="text-black-50">Sign Up</a></p>
                        ...
                        <form action="{{ route('instructorLogin.store', 'instructorDashboard') }}" method="POST">
                            @csrf
